...
If you're new to programming, getting Python installed on your laptop can be confusing — different steps for Mac vs Windows, "PATH" errors, version mismatches, etc.

This repository skips all of that. When you click the button:

1. GitHub creates a **complete coding environment** for you in the cloud (free).
2. Visual Studio Code opens **in your browser**, with Python ready to go.
3. You write code, hit ▶ Run, and see results — exactly like a local install.

No downloads. No installation. Works on **any** computer with a browser, including Chromebooks and iPads.
...
- **Your work is saved automatically** while the Codespace is open.
- Codespaces sleep after 30 minutes of inactivity (your code is kept; just click the button again to resume).
...
The actual lecture slides, exercises, and solutions are in the main course repository, which your lecturer will share separately. **This repo is just for the coding environment** so you have a frictionless place to write and run Python.
